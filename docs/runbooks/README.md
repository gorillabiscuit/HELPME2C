...
- [V4 extraction](v4-extraction.md) — LLM content-descriptor pipeline (per [ADR-0025](../decisions/0025-viewer-experience-extraction.md) / [ADR-0026](../decisions/0026-content-descriptor-storage.md) / [ADR-0027](../decisions/0027-content-descriptor-scoring.md)) — note: scripts referenced live on the `feat/v4-content-descriptors` branch until that PR merges
